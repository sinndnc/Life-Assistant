...
import com.android.lifeassistant.feature.component.triangle.TriangleRightEdgeShape
import com.android.lifeassistant.feature.presentation.main._message._chat.ChatViewModel

@Composable
fun ChatRightBubbleComponent(
    isSelected: Boolean,
    ...
    Column(
        ...
        Row(
            ...
            Column(
                modifier = Modifier
                    .background(
                        color = Blue500.copy(0.4f), shape = RoundedCornerShape(8.dp, 8.dp, 0.dp, 8.dp)
                    )
                    .padding(5.dp)
                    .wrapContentWidth()
            ) {
            ...
            Box(
                modifier = Modifier
                    .background(
                        color = Blue500.copy(0.4f), shape = TriangleRightEdgeShape()
                    )
                    .width(8.dp)
                    .fillMaxHeight()
            )
